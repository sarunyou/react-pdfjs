...
const PDFViewerApplication = {
  ...
  async open(args) {
    ...
    pdfjs_lib__WEBPACK_IMPORTED_MODULE_8__.GlobalWorkerOptions = Object.assign(workerParams, pdfjs_lib__WEBPACK_IMPORTED_MODULE_8__.GlobalWorkerOptions);
    if (args.url) {
    ...
    Promise.all([firstPagePromise, permissionsPromise]).then(_ref2 => {
      ...
      if (annotationEditorMode !== pdfjs_lib__WEBPACK_IMPORTED_MODULE_12__.AnnotationEditorType.DISABLE) {
        ...
        if (pdfDocument.isPureXfa) {
          ...
          this.#annotationEditorUIManager = new pdfjs_lib__WEBPACK_IMPORTED_MODULE_12__.AnnotationEditorUIManager(this.container, this.viewer, this.#altTextManager, this.eventBus, pdfDocument, this.pageColors, this.#annotationEditorHighlightColors, this.#mlManager);
