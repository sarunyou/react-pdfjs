...
import type {  PDFPageProxy } from "./pdfjs/types/src/pdf.d.ts";
import { PDFViewerApplication } from "./pdfjs/generic/web/viewer.mjs";
import "./pdfjs/generic/web/viewer.css";
