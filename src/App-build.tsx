...
import { GlobalWorkerOptions } from './pdfjs/build/pdf.worker.mjs';
// import "pdfjs-dist/web/pdf_viewer.css";
import "./pdfjs/web/viewer.css";
import "./pdfjs/components/pdf_viewer.css";
...
import type {
  PDFDocumentProxy,
  PDFPageProxy,
} from "./pdfjs/types/src/pdf.d.ts";
import { PDFViewerApplication } from "./pdfjs/web/viewer.mjs";
import { AppOptions } from "./pdfjs/default_preferences/generic/app_options.mjs";
import { GlobalWorkerOptions } from "./pdfjs/build/pdf.worker.mjs";
// import "pdfjs-dist/web/pdf_viewer.css";
import "./pdfjs/web/viewer.css";
import "./pdfjs/components/pdf_viewer.css";
...
window.pdfjs = pdfjs;
window.PDFViewerApplication = PDFViewerApplication;
// AppOptions.set("workerSrc", "src/pdfjs/build/pdf.worker.mjs");

pdfjs.GlobalWorkerOptions.workerSrc = "src/pdfjs/build/pdf.worker.mjs";
// pdfjs.AppOptions.set("workerSrc", "src/pdfjs/build/pdf.worker.mjs");
function App() {
  const getViewerConfiguration = () => {
    return {
      appContainer: document.body,
