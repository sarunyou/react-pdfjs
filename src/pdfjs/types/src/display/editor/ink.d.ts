...
export class InkEditor extends AnnotationEditor {
     ...
     * @returns {Path2D}
     */
    static "__#23@#buildPath2D"(bezier: Array<Array<number>>): Path2D;
    static "__#23@#toPDFCoordinates"(points: any, rect: any, rotation: any): any;
    static "__#23@#fromPDFCoordinates"(points: any, rect: any, rotation: any): any;
    /** @inheritdoc */
